...
//        CredentialInputValidator
{
    ...
    public MyUserStorageProvider(KeycloakSession session, ComponentModel model, UserRepo repository) {
...
//    }
    ...
    public UserModel getUserById(String id, RealmModel realm) {
        ...
        return new MyUserAdapter(session, realm, model, repository.findById(externalId).orElse(new User()));
    }

    @Override
    public UserModel getUserByUsername(String username, RealmModel realm) {
        return new MyUserAdapter(session, realm, model, repository.findByLogin(username));
    }
